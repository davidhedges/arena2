...
{
    public static class LoadoutActionTrace
    {
        ...
        {
            var go = new GameObject("LoadoutActionTrace");
            UnityEngine.Object.DontDestroyOnLoad(go);
            go.AddComponent<LoadoutActionTraceMonitor>();
        }
        ...
        private sealed class LoadoutActionTraceMonitor : MonoBehaviour
        {
            private void Update()
            {
