...
namespace Arena.RehearsalHubV2Db
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(MatchPlayerCombatBuildSnapshotV2 = new(conn));
            AddTable(MyCombatBuildV2 = new(conn));
            AddTable(Phase2ProbeResult = new(conn));
            AddTable(Phase3HandoffResult = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        internal static string[] AllTablesSqlQueries() => new string[]
        {
            ...
            new QueryBuilder().From.MatchPlayerCombatBuildSnapshotV2().ToSql(),
            new QueryBuilder().From.MyCombatBuildV2().ToSql(),
            new QueryBuilder().From.Phase2ProbeResult().ToSql(),
            new QueryBuilder().From.Phase3HandoffResult().ToSql(),
        }
        ;
    }
    ...
    public sealed class From
    {
        ...
        public global::SpacetimeDB.Table<MatchPlayerCombatBuildSnapshotV2, MatchPlayerCombatBuildSnapshotV2Cols, MatchPlayerCombatBuildSnapshotV2IxCols> MatchPlayerCombatBuildSnapshotV2() => new("match_player_combat_build_snapshot_v_2", new MatchPlayerCombatBuildSnapshotV2Cols("match_player_combat_build_snapshot_v_2"), new MatchPlayerCombatBuildSnapshotV2IxCols("match_player_combat_build_snapshot_v_2"));
        ...
        public global::SpacetimeDB.Table<Phase2ProbeResult, Phase2ProbeResultCols, Phase2ProbeResultIxCols> Phase2ProbeResult() => new("phase_2_probe_result", new Phase2ProbeResultCols("phase_2_probe_result"), new Phase2ProbeResultIxCols("phase_2_probe_result"));
        public global::SpacetimeDB.Table<Phase3HandoffResult, Phase3HandoffResultCols, Phase3HandoffResultIxCols> Phase3HandoffResult() => new("phase_3_handoff_result", new Phase3HandoffResultCols("phase_3_handoff_result"), new Phase3HandoffResultIxCols("phase_3_handoff_result"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.PreparePhase3ThreeSchoolHandoff args => Reducers.InvokePreparePhase3ThreeSchoolHandoff(eventContext, args),
                Reducer.RunPhase2LiveProbe args => Reducers.InvokeRunPhase2LiveProbe(eventContext, args),
