...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Mouse sensitivity multiplier for camera orbit")]
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                {
                    // RMB held: movement direction relative to camera.
                    _targetRotation = Mathf.Atan2(inputDirection.x, inputDirection.z) * Mathf.Rad2Deg +
                                      _mainCamera.transform.eulerAngles.y;
                }
                else
                {
                    // No RMB: movement direction relative to character's current facing.
                    _targetRotation = Mathf.Atan2(inputDirection.x, inputDirection.z) * Mathf.Rad2Deg +
                                      transform.eulerAngles.y;
                }

                // Always rotate character to face movement direction.
