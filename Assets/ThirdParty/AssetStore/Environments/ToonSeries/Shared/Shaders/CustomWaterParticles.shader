...
Shader "Toon/CustomWaterParticles"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Color = ( _Color * tex2DNode640 * float4( ase_mainLightColorLDR , 0.0 ) * ase_mainLightShadowAtten ).rgb;
...
{"wire":[666,4,662,0]}
ASEEND*/
//CHKSM=AC7D37C1185EC903FA95B07881B829B67DA30EC0