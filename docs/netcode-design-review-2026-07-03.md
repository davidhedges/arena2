...
(§1 item 2, D4). Evidence: `retired pre-cutover S8 lag-compensation harness` (self-verifying,
...
`retired pre-cutover S4 LOS harness` is a headless websocket player that walks flush
