...
Three ordinary websocket players in an arena instance: an attacker with the
three canonical Mortality abilities, a victim who receives all of them, and a control
...
Typical isolated local run:
  ...
  ARENA_DATABASE=shadowkitprobe ARENA_PROJECTILE_LOAD_HARNESS=1 \
    ARENA_GENERATE_BINDINGS=0 ARENA_VERIFY_DOTNET=0 \
    ./ops/republish-local-clear.sh
  python3 ops/shadow-kit-probe.py --database shadowkitprobe
...
DARKNESS_ABILITY = "DAGGER_DARKNESS"
DARKNESS = "DARKNESS"
STALK_ABILITY = "DAGGER_STALK"
STALK = "STALK"
SHADOWREND_ABILITY = "DAGGER_SHADOWREND"
