...
Typical isolated local run:
  ...
  ARENA_DATABASE=cauterizeprobe ARENA_PROJECTILE_LOAD_HARNESS=1 \
...
CAUTERIZE_ABILITY = "SPELL_CAUTERIZE"
CAUTERIZE = "CAUTERIZE"
GRAVEBURST_ABILITY = "SPELL_GRAVEBURST"
